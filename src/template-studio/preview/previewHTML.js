...
export function previewHTML(page, brand) {
  ...
  const isVideoPortfolio = ["Portfolio Video — Home","Portfolio Video — Films","Portfolio Video — About","Portfolio Video — Contact"].includes(page.pageType);
  const isPhotoPortfolio = ["Portfolio Photog — Home","Portfolio Photog — Gallery","Portfolio Photog — About","Portfolio Photog — Contact"].includes(page.pageType);
