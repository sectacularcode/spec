  ...
  return (
    <div style={S.wrap}>
      ...
      <div style={S.body}>
        ...
        {/* TEMPORARY: isManager gate removed so an admin whose Postgres
            profile hasn't been migrated yet can still reach the migration
            button below. Restore `{isManager && (...)}` once the one-time
            migration has run and api/migrate-profiles-onetime.js is deleted. */}
